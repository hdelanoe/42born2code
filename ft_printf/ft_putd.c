...
static void	accu_fld(t_env *e, t_buff *buff, char *sign)
{
...
static void	ft_convert_arg(va_list arg, t_env *e, int s, t_buff *buff)
{
	if (e->flag[5] >= 2)
	{
...
static void	minus(t_env *e, t_buff *buff, char *sign)
{
	if (e->flag[0] > 0)
	{
		ft_putstr(sign);
...
static char	*ft_sign(t_env *e, t_buff *buff)
{
	int		neg;
	char	*sign;
	int		i;
