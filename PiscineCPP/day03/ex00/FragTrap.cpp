...
{
	if (type == 0)
		std::cout << "FR4G-TP " << this->_Name << " spit on " << target << " face, causing " << this->_RangedAttackDamage << " points of wet damage !" << std::endl;
	else if (type == 1)
		...
		std::cout << "FR4G-TP " << this->_Name << " throws a huge rocket on " << target << " with his Redemption, causing " << this->_RangedAttackDamage << " points of splash damage !" << std::endl;
}
...
void	FragTrap::meleeAttack(std::string const & target, int type) const
{
	if (type == 0)
		...
		std::cout << "FR4G-TP " << this->_Name << " crush " << target << " with his whells 0 while dancing, causing " << this->_MeleeAttackDamage << " points of shame damage !" << std::endl;
	else
